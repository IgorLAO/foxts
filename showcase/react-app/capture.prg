* capture.prg — abre cada pagina do showcase (SCX em dist\) e captura a tela REAL do VFP
...
= shoot(lcDir + "dist\DashboardPage.scx", lcDir + "dist\01-dashboard.png")
= shoot(lcDir + "dist\ClientesPage.scx", lcDir + "dist\02-clientes.png")
...
PrintWindow(lhWnd, lhdcMem, 2)  && PW_RENDERFULLCONTENT
ReleaseDC(0, lhScr)
lnImg = 0
